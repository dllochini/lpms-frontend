  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto", p: 3 }}>
      ...
      <Stack direction="row" spacing={2}  justifyContent="center" alignItems="center" sx={{ mb: 2 }}>
        <Button variant="outlined" sx={{ borderRadius: 20, px: 3 }} component={RouterLink} to="/higherManager/dashboard">Home</Button>
        {/* <Button variant="outlined" component={RouterLink} to="/operations">Operations Approval</Button> */}
        <Button variant="contained" sx={{ borderRadius: 20, px: 3 }} color="primary" component={RouterLink} to="/payments">Payments Approval</Button>
        <Button variant="outlined" sx={{ borderRadius: 20, px: 3 }} component={RouterLink} to="/land-progress">Land Progress</Button>
      </Stack>
